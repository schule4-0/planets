...
const ClickSpaceship: React.FC = () => {
    const router = useRouter();

    const actionButtonRef = useRef<HTMLInputElement>(null);
    const images = [
        { id: 'Top', src: '/images/spaceship/spaceship_top.png', alt: 'Raumschiffteil Oben' },
        { id: 'Middle1', src: '/images/spaceship/spaceship_middle1.png', alt: 'Raumschiffteil Mitte1' },
        { id: 'Middle2', src: '/images/spaceship/spaceship_middle2.png', alt: 'Raumschiffteil Mitte2' },
