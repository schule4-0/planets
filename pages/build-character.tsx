...
const BuildCharacter: React.FC = () => {
    ...
    const renderLeftChildren = () => (
        <div className="h-full w-full flex justify-center items-center">
            <SVGColorChanger color={selectedHairColorCode} type={"character/" + selectedHair}
                ...
                <SelectItems
                    ...
                    components={[
                        <SVGColorChanger
                            ...
                            type="character/short-curly-hair"
                            skinColor={selectedSkinColorCode}
                        />,
                        <SVGColorChanger
                            key="short-straight-hair"
                            color={selectedHairColorCode}
                            type="character/short-straight-hair"
                            skinColor={selectedSkinColorCode}
                        />,
                        <SVGColorChanger
                            key="long-curly-hair"
                            color={selectedHairColorCode}
                            type="character/long-curly-hair"
                            skinColor={selectedSkinColorCode}
                        />,
                        <SVGColorChanger
                            key="long-straight-hair"
                            color={selectedHairColorCode}
                            type="character/long-straight-hair"
                            skinColor={selectedSkinColorCode}
                        />,
                    ]}
